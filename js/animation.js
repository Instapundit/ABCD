...
const config = {
    ...
    nickname: "Arshu", // nickname(optional)

    pic: "(../resources/img/bgirl.jpeg", //image url of recipients (Mandatory)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Happy BDay My Friend Arshu";
